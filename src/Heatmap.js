...
class Heatmap extends React.Component {
  ...
  constructor(props) {
    ...
    this._ctx = this.canvas.current;
    this.gradient = this.gradient.bind(this);
    this.draw = this.draw.bind(this);
    this._colorize = this._colorize.bind(this);
    this._createCanvas = this._createCanvas.bind(this);
  }
  ...
  draw(minOpacity) {
    ...
    var colored = ctx.getImageData(0, 0, this.canvas.current.width, this.canvas.current.height);
